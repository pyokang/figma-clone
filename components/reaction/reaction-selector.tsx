// source: https://github.com/liveblocks/liveblocks/tree/main/examples/nextjs-live-cursors-chat/components

type TProps = {
  setReaction: (reaction: string) => void;
};

export function ReactionSelector({ setReaction }: TProps) {
  return (
    <div
